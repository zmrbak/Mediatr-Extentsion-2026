using EnvDTE;
using EnvDTE80;
using Mediatr_Extentsion_2026.Decorators;
using Mediatr_Extentsion_2026.Definitions;
using Mediatr_Extentsion_2026.Extensions;
using Mediatr_Extentsion_2026.Models;
using Mediatr_Extentsion_2026.Services;
using Mediatr_Extentsion_2026.Views;
using Microsoft;
...
namespace Mediatr_Extentsion_2026.Commands
{
    internal sealed class AddMediatRItemCommand
    {
        ...
        public static readonly Guid CommandSet = new Guid("0275377e-db6f-4b7f-83d8-089572a36488");
        ...
        private void AddConstructorToRequestHandler(CodeClass codeClass, CreateMessage model)
        {
            ...
            {
                ThreadHelper.ThrowIfNotOnUIThread();
                constructor.AddParameter(x.Name, x.Type, -1);
            });
            constructorParameters.ForEach(x =>
            {
            ...
            {
                ThreadHelper.ThrowIfNotOnUIThread();
                constructorEditPoit.Insert(model.RequestHandlerIndent + "this." + x.Name + " = " + x.Name + ";" + Environment.NewLine);
            });
        }
